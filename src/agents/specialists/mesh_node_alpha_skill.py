...
class MeshNodeAlphaSkill:
    ...
    def report_telemetry(self):
        ...
        telemetry = {
            ...
            "vitality_mod": "linked_from_eeg_flame_001",   # ← new bridge to MeshNode EEG
            "muon_events": 42,                             # ← pulled from FlameQuantumNode
            "glyph_hash": "a3f7b9c2d1e4f567"              # ← from quantum scrape
        }
        ...
        # Send over rad-hard acoustic (79 Hz TOFT)
        self.acoustic.transmit(json.dumps(telemetry))
