"""
core/sql_tau_decalogue_sealed.py
...
GlyphParser + Handshake + 19.5 kHz ultrasound on alignment
March 12, 2026
"""
...
# 10D Decalogue Constants (your notarized map)
DECALOGUE = {
...
class DecalogueValidator:
    ...
    def validate_node(self, node_id: int, reported_pi: float):
        ...
        if abs(reported_pi - expected) > 0.0001:
            ...
            Handshake.createReceipt(None, "10D-VETO", {
                "node_id": node_id,
                "expected": expected,
                "reported": reported_pi
            })
            return False

        # Sovereign receipt + Glyph + ultrasound
        receipt = Handshake.createReceipt(None, "DECALOGUE-CHECK-SUM", {
            "node_id": node_id,
            "dimension": dimension,
